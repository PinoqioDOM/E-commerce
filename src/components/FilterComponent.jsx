...
  const [isMobileFilterOpen, setIsMobileFilterOpen] = useState(false); // ახალი state მობილურის მენიუსთვის
...
  return (
    <>
      {/* მობილურის ვერსია - ღილაკი */}
      <div className="md:hidden">
        <button
          onClick={() => setIsMobileFilterOpen(!isMobileFilterOpen)}
          className="w-full py-3 px-6 bg-[#90EE90] text-gray-800 font-bold rounded-lg shadow-md hover:bg-[#83E683] transition-colors mb-4"
        >
          ფილტრი და დალაგება
        </button>
      </div>

      {/* ფილტრის კონტენტი - მობილურზე იხსნება ღილაკით, დიდ ეკრანზე ყოველთვის ჩანს */}
      <aside 
        className={`
          md:block w-full p-6 bg-white rounded-lg shadow-lg border border-gray-200

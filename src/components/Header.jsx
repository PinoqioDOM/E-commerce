...
const Header = () => {
  ...
  const { cartItemCount, removeFromCart } = useCart();
  ...
  return (
    <div className="relative">
      <div className="flex items-center justify-between px-4 py-2 bg-[#90EE90] relative md:justify-center md:gap-8">
        ...
        {/* საძიებო ველი - ჩანს მხოლოდ დიდ ეკრანებზე */}
        <div className="relative items-center hidden md:flex flex-grow max-w-lg mx-4">
          <input
            type="text"
            name="search"
            id="search"
            className="p-3 text-base border-none rounded-lg outline-none bg-white w-full transition-shadow hover:shadow-[0_0_10px_#000] cursor-pointer"
